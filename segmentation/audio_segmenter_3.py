...
def segment_wavfile(wavfilename:str, segments_folder:str ,bookkeep_folder:str = 'segmentation_bookkeep'):
    """Main logic for segmenting a single wavfile.
...
#     # # TODO: UNZIP
    ...
    try:
        ...
        wavfiles_location = make_wavfile_output_folder(wavfilename)
        # input(wavfiles_location)
        ...
        segments_metadata_df.to_csv(csv_filename, sep="\t")
        print(f"metadata csv written to {csv_filename}")
...
if __name__ == "__main__":
    ...
    segment_wavfile('../testfile2.wav', 'test_segments')
